...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7ff9402058e0>'

__spec__ = None # (!) real value is "ModuleSpec(name='parser', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7ff9402058e0>, origin='/Library/Frameworks/Python.framework/Versions/3.9/lib/python3.9/lib-dynload/parser.cpython-39-darwin.so')"

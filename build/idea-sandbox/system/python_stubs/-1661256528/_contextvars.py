...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fa1481258e0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_contextvars', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fa1481258e0>, origin='/Library/Frameworks/Python.framework/Versions/3.9/lib/python3.9/lib-dynload/_contextvars.cpython-39-darwin.so')"

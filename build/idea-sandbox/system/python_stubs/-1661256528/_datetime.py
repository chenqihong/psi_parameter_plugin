...
datetime_CAPI = None # (!) real value is '<capsule object "datetime.datetime_CAPI" at 0x7f9970475690>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f99704758e0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_datetime', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f99704758e0>, origin='/Library/Frameworks/Python.framework/Versions/3.9/lib/python3.9/lib-dynload/_datetime.cpython-39-darwin.so')"
